...
class SettingsProvider extends ChangeNotifier {
  ...
  Future<void> _loadPreferences() async {
    ...
    _isDarkMode =
        prefs.getBool('isDarkMode') ?? false; // ✅ Cargar el modo oscuro
    notifyListeners();
  }
  ...
  Future<void> _savePreferences() async {
    ...
    await prefs.setBool(
        'isDarkMode', _isDarkMode); // ✅ Guardar el estado del modo oscuro
  }
      ...
      body: ListView(
        children: [
          SwitchListTile(
            ...
            onChanged: (value) {
              settingsProvider
                  .setTheme(value); // ✅ Cambia el tema dinámicamente
            },
          ),
          SwitchListTile(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                    onPressed: () {
                      Provider.of<CatalogosProvider>(context, listen: false)
                          .actualizarDesdeApi();
                    },
