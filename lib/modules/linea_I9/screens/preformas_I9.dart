...
import 'package:control_de_calidad/modules/linea_I9/screens/screen_ctrl_MP.dart';
import 'package:control_de_calidad/modules/linea_I9/screens/screen_ctrl_pesos.dart';
import 'package:control_de_calidad/modules/linea_I9/screens/screen_datosiniciales.dart';
import 'package:control_de_calidad/modules/linea_I9/screens/screen_defectos.dart';
import 'package:control_de_calidad/modules/linea_I9/screens/screen_procesos.dart';
import 'package:control_de_calidad/modules/linea_I9/screens/screen_temperaturas.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:persistent_bottom_nav_bar/persistent_bottom_nav_bar.dart';
import 'package:provider/provider.dart';

class ScreenPreformasI9 extends StatefulWidget {
  const ScreenPreformasI9({super.key});

  @override
  State<ScreenPreformasI9> createState() => _ScreenPreformasI9State();
}

class _ScreenPreformasI9State extends State<ScreenPreformasI9> {
  final PersistentTabController _controller =
      PersistentTabController(initialIndex: 0);

  List<Widget> _buildScreens() {
    return [
      ScreenDatosprincipalesi9(),
      ScreenListDatosMPI9(),
      ScreenListDatosDEFI9(),
      ScreenListDatosPESOSI9(),
      ScreenListDatosPROCEI9(),
      ScreenListDatosTEMPI9(),
    ];
  }
    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider(
              create: (_) => EditProviderDatosDEFI9(
          ...
          appBar: PreferredSize(
            ...
            child: AppBar(
              ...
              flexibleSpace: Stack(
                children: [
                  const Image(
                    image: AssetImage('images/bannerI9.png'),
                    height: 150,
