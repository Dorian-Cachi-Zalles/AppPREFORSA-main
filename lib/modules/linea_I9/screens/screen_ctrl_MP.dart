...
class ScreenListDatosMPI9 extends StatefulWidget {
  @override
  State<ScreenListDatosMPI9> createState() => _ScreenListDatosMPI9State();
}

class _ScreenListDatosMPI9State extends State<ScreenListDatosMPI9> {
  @override
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      OutlinedButton(
                        ...
                        onPressed: () async {
                          int? idregistro =
                              await providerregistro.getNumeroById(2);
    ...
    return ChangeNotifierProvider(
        ...
        child: Consumer<EditProviderDatosMPIPS>(
          ...
          return Scaffold(
                            ...
                            return ListaGenericaScreen2(
                              ...
                              onPress: (idSeleccionado, idsSeleccionados,
                                ...
                                final actualizarEstado = _datosMpIps.copyWith(
                                    ...
                                    materiaPrima: MP);
                                providerI9ProviderI9.updateMateriaPrima(
            ...
            BotonDeslizableGenerico<ProviderI9, ModeloMateriaPrima>(
              colorcito: Config.colores[2]!,
    ...
    return ChangeNotifierProvider(
        ...
        child: Consumer<EditProviderDatosColoranteIPS>(
          ...
          return Scaffold(
            ...
            BotonDeslizableGenerico<ProviderI9, ModeloColorante>(
              obtenerHasError: (provider, id) {
                final item =
