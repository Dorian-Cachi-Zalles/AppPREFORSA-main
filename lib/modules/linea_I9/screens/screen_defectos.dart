...
import 'package:control_de_calidad/modules/linea_I9/screens/screen_observados.dart';
import 'package:control_de_calidad/modules/linea_I9/widgets/widget_defectosips.dart';
import 'package:flutter/material.dart';
import 'package:flutter_form_builder/flutter_form_builder.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';

class ScreenListDatosDEFI9 extends StatelessWidget {
  @override
  ...
  if (dtdatosproducicionobservada != null) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      ...
      bottomNavigationBar: BotonAgregar(
        ...
        onPressed: () async {
          int? idregistro = await providerregistro.getNumeroById(2);
...
class _EditDatosDEFIPSFormState extends State<EditDatosDEFIPSForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        ...
        child: Consumer<EditProviderDatosDEFI9>(
          ...
          return Scaffold(
                      ...
                      provider.mostrarFormulario1
                          ? Column(
                              children: [
                                  ...
                                  accion: () async {
                                    ...
                                    final updatedDatito =
                                        obtenerDatosActualizados(
                                            isObservado: false);
                                    await providerI9.updateDefectos(
                                ...
                                FormularioGeneralDatosProduccionObervadaI9(
            ...
            BotonDeslizableConId<ProviderI9, ModeloDefectos, ModeloObservados>(
              colorcito: Config.colores[2]!,
