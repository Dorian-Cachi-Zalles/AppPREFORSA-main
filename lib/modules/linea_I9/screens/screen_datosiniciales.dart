...
import 'package:control_de_calidad/modules/linea_I6/models/DatosInicialesI9.dart';
import 'package:control_de_calidad/modules/linea_I9/providers/DatosProviderPrefI9.dart';
import 'package:flutter/material.dart';
import 'package:flutter_form_builder/flutter_form_builder.dart';
import 'package:provider/provider.dart';

class ScreenDatosprincipalesi9 extends StatefulWidget {
  ScreenDatosprincipalesi9({super.key});

  @override
  State<ScreenDatosprincipalesi9> createState() =>
      _ScreenDatosprincipalesi9State();
}

class _ScreenDatosprincipalesi9State extends State<ScreenDatosprincipalesi9> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ProviderI9>(
      builder: (context, provider, child) {
        ...
        void _guardarAuto(ModeloDatosPrincipalesI9 datos) {
        ...
        Timer? _debounce;
        void _guardarAutoDebounce(ModeloDatosPrincipalesI9 datos) {
        ...
        return Scaffold(
            ...
            bottomNavigationBar: BotonDeslizableGenericoInicial<ProviderI9,
                    ModeloDatosPrincipalesI9>(
