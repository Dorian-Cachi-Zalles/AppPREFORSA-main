...
class DefectosScreenWidgetI9 extends StatefulWidget {
  final int id;
  const DefectosScreenWidgetI9({required this.id, Key? key}) : super(key: key);

  @override
  _DefectosScreenState createState() => _DefectosScreenState();
}

class _DefectosScreenState extends State<DefectosScreenWidgetI9> {
  ...
  Map<String, Map<String, String>> defectosImages = {
    ...
    'ACE': {
      'name':
          'Arrastre de cola de inyección en la superficie exterior de la pref.',
      'image': 'images/nohayfoto.avif',
    },
    'ACI': {
      'name':
          'Arrastre de cola de inyección en la superficie interior de la pref.',
      'image': 'images/nohayfoto.avif',
    },
    'AII': {
  ...
  Widget build(BuildContext context) {
    final datosProvider = Provider.of<ProviderI9>(context);
    final ProviderOpciones = Provider.of<EditProviderDatosDEFI9>(context);
