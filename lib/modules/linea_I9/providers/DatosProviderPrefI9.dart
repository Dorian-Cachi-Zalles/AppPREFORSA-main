...
class ProviderI9 with ChangeNotifier {
  late Database _db;
  final RepoDatosPrincipales =
      GenericRepositoryDatosList<ModeloDatosPrincipalesI9>(
    tableName: 'tablaDatosPrincipales',
    fromMap: (map) => ModeloDatosPrincipalesI9.fromMap(map),
    toMap: (d) => d.toMap(),
  ...
  Future<void> addDatosPrincipales() async {
    final ModeloDatosPrincipalesI9 nuevoDato =
        ModeloDatosPrincipalesI9.fromMap(defaultValuesDatosIniciales);
  ...
  Future<void> updateDatosPrincipales(
      int id, ModeloDatosPrincipalesI9 updatedDato) async {
