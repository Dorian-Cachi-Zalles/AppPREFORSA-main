...
import 'package:control_de_calidad/modules/linea_Coloracap/screens/screen_observadosColora.dart';
import 'package:control_de_calidad/modules/linea_Coloracap/widgets/widgetDefectosI6.dart';
import 'package:control_de_calidad/modules/linea_Coloracap/widgets/widget_defectosips.dart';
...
class ScreenListDatosDEFColora extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    final String urlOV = "${Config().baseUrl}/es";
    ...
    ,                                  
                            ...
                            onOpenModal: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditDatosDEFColora(
                                    id: dtdatosdefips.id!,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      ...
      bottomNavigationBar: BotonAgregar(
        ...
        onPressed: () async {
          ...
          provider.addDefectos(ModeloDefectosColora(
            hasErrors: true,
            hasSend: false,
...
class EditProviderDatosDEFColora with ChangeNotifier {
  bool _mostrarFormulario1;
  bool _mostrarFormulario2;
  List<String>? todasLasOpciones;

  EditProviderDatosDEFColora({
...
class EditDatosDEFColora extends StatefulWidget {
  final int id;
  final ModeloDefectosColora datosDefIps;
  final ModeloObservados tablaProduccionObservada;

  const EditDatosDEFColora(
      {required this.id,
  ...
  @override
  _EditDatosDEFColoraState createState() => _EditDatosDEFColoraState();
}

class _EditDatosDEFColoraState extends State<EditDatosDEFColora> {
  ...
  Widget build(BuildContext context) {
    ...
    final dato = context
        .watch<ProviderColora>()
        .RepoDefectos
        .items
        .firstWhere((d) => d.id == widget.id);
    final List<String> opcionesVariables = List<String>.from(dato.defectos);
    final providerColoraProviderColora = Provider.of<ProviderColora>(context, listen: false);
    ...
    return ChangeNotifierProvider(
        ...
        child: Consumer<EditProviderDatosDEFColora>(
          ...
          return Scaffold(
            ...
            Expanded(
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      FormularioGeneralDatosDEFColora(
                          ...
                          ? Column(
                              children: [
                                Titulos(
                                  ...
                                  subtitulo: 'Eliminar',
                                  accion: () async {
                                    final providerColoraProviderColora = Provider.of<ProviderColora>(
                                      context,
                                      listen: false,
                                    );
                                    final updatedDatito =
                                        obtenerDatosActualizados(
                                            isObservado: false);
                                    await providerColoraProviderColora.updateDefectos(
                                              ...
                                              builder: (context) {
                                                return ListaGenericaScreen2(
                                                  ...
                                                  onPress: (idSeleccionado,
                                                    ...
                                                    providerColoraProviderColora.updateObservados(
                                                        _datos.id!,
                                                        actualizarEstado);
                                ...
                                FormularioGeneralObervadoColora(
            ...
            BotonDeslizableConId<ProviderColora, ModeloDefectosColora, ModeloObservados>(
              colorcito: Config.colores[3]!,
  ...
  ModeloDefectosColora obtenerDatosActualizados(
...
class FormularioGeneralDatosDEFColora extends StatefulWidget {
  const FormularioGeneralDatosDEFColora({
    super.key,
  ...
  final ModeloDefectosColora widget;
  final Map<String, List<dynamic>> dropOptions;
  final int id;

  @override
  State<FormularioGeneralDatosDEFColora> createState() =>
      _FormularioGeneralDatosDEFColoraState();
}

class _FormularioGeneralDatosDEFColoraState
    extends State<FormularioGeneralDatosDEFColora> {
  @override
  Widget build(BuildContext context) {
    void _guardarAuto(ModeloDefectosColora datos) {
    ...
    Timer? _debounce;
    void _guardarAutoDebounce(ModeloDefectosColora datos) {
          ...
          child: Row(
            children: [
              for (var item in [
                ...
                {
                  'label': 'Tens Superficial',
                  'name': 'TensSuperficial',
                  'value': widget.widget.TensSuperficial
                },
              ])
                Padding(
