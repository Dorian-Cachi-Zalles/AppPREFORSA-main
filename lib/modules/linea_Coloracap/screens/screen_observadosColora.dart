...
class FormularioGeneralObervadoColora extends StatefulWidget {
  const FormularioGeneralObervadoColora({
    super.key,
  ...
  @override
  State<FormularioGeneralObervadoColora> createState() =>
      _FormularioGeneralObervadoColoraState();
}

class _FormularioGeneralObervadoColoraState
    extends State<FormularioGeneralObervadoColora> {
