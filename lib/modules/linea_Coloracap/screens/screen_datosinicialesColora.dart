...
class ScreenDatosprincipalesColora extends StatefulWidget {
  ScreenDatosprincipalesColora({super.key});

  @override
  State<ScreenDatosprincipalesColora> createState() =>
      _ScreenDatosprincipalesColoraState();
}

class _ScreenDatosprincipalesColoraState extends State<ScreenDatosprincipalesColora> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ProviderColora>(
      builder: (context, provider, child) {
        ...
        void _guardarAuto(ModeloDatosPrincipalesColora datos) {
        ...
        Timer? _debounce;
        void _guardarAutoDebounce(ModeloDatosPrincipalesColora datos) {
        ...
        List<Widget> fields = [
          ...
          CustomInputField(
            ...
            isNumeric: true,
            valorInicial:
                datos.tiempoCicloCalidad == 0 ? '' : datos.tiempoCicloCalidad.toString(),
          ),
        ...
        return Scaffold(
            ...
            bottomNavigationBar: BotonDeslizableGenericoInicial<ProviderColora,
                    ModeloDatosPrincipalesColora>(
