...
class DefectosScreenWidgetColora extends StatefulWidget {
  final int id;
  const DefectosScreenWidgetColora({required this.id, Key? key}) : super(key: key);

  @override
  _DefectosScreenColoraState createState() => _DefectosScreenColoraState();
}

class _DefectosScreenColoraState extends State<DefectosScreenWidgetColora> {
  ...
  Widget build(BuildContext context) {
    final datosProvider = Provider.of<ProviderColora>(context);
    final ProviderOpciones = Provider.of<EditProviderDatosDEFColora>(context);
