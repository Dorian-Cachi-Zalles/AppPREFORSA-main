...
class _ScreenCCMState extends State<ScreenCCM> {
  ...
  List<Widget> _buildScreens() {
    return [
      ScreenDatosprincipalesCCM(),
      ScreenListDatosMPCCM(),
      ScreenListDatosDEFCCM(),
     ScreenListDatosDef2CCM(),
      ScreenListDatosPESOSCCM(),
    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider(
              create: (_) => EditProviderDatosDEFccm(
          ...
          appBar: PreferredSize(
            ...
            child: AppBar(
              ...
              flexibleSpace: Stack(
                children: [
                  const Image(
                    image: AssetImage('images/BannerCCM.png'),
                    height: 150,
