...
class DefectosScreenWidgetccm extends StatefulWidget {
  final int id;
  const DefectosScreenWidgetccm({required this.id, Key? key}) : super(key: key);

  @override
  _DefectosScreenState createState() => _DefectosScreenState();
}

class _DefectosScreenState extends State<DefectosScreenWidgetccm> {
  ...
  Widget build(BuildContext context) {
    final datosProvider = Provider.of<ProviderCCM>(context);
