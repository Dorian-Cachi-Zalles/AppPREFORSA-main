class ModeloDatosPrincipalesCCM {
  final int? id;
  ...
  const ModeloDatosPrincipalesCCM({
    this.id,
  ...
  factory ModeloDatosPrincipalesCCM.fromMap(Map<String, dynamic> map) {
    return ModeloDatosPrincipalesCCM(
      id: map['id'] as int?,
  ...
  ModeloDatosPrincipalesCCM copyWithForm(Map<String, dynamic> formValues,
  ...
  ModeloDatosPrincipalesCCM copyWith(
      {int? id,
      bool? hasErrors,
      int? cod_parte,
      String? modalidad,
...
extension ModeloDatosPrincipalesCCMApi on ModeloDatosPrincipalesCCM {
