class ModeloDatosPrincipalesSoplado1 {
  final int? id;
  ...
  const ModeloDatosPrincipalesSoplado1({
    this.id,
  ...
  factory ModeloDatosPrincipalesSoplado1.fromMap(Map<String, dynamic> map) {
    return ModeloDatosPrincipalesSoplado1(
      id: map['id'] as int?,
  ...
  ModeloDatosPrincipalesSoplado1 copyWithForm(Map<String, dynamic> formValues,
    ...
    return ModeloDatosPrincipalesSoplado1(
        ...
        tiempoCicloCalidad: TiempoCiclo ?? tiempoCicloCalidad,
  ...
  ModeloDatosPrincipalesSoplado1 copyWith(
      {int? id,
      bool? hasErrors,
      int? cod_parte,
      String? modalidad,
...
extension ModeloDatosPrincipalesSoplado1Api on ModeloDatosPrincipalesSoplado1 {
