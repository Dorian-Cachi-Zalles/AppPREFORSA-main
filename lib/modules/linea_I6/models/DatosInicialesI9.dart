class ModeloDatosPrincipalesI9 {
  final int? id;
  ...
  const ModeloDatosPrincipalesI9({
    this.id,
  ...
  factory ModeloDatosPrincipalesI9.fromMap(Map<String, dynamic> map) {
    return ModeloDatosPrincipalesI9(
      id: map['id'] as int?,
  ...
  ModeloDatosPrincipalesI9 copyWithForm(Map<String, dynamic> formValues,
  ...
  ModeloDatosPrincipalesI9 copyWith(
      {int? id,
      bool? hasErrors,
      int? cod_parte,
      String? modalidad,
...
extension ModeloDatosPrincipalesI9Api on ModeloDatosPrincipalesI9 {
